...
- internal/mcpsmoke: controlled fake/test MCP stdio smoke, fake read-only tool-smoke, real read-only discovery smoke, policy scaffolds, and transcript artifacts only
