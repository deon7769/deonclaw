...
Usage:
  ...
  deonctl work dispatch-once --store <deonclaw.db> --work-item <id> [--lease <lease-id>] --artifacts-dir <dir> --registry-root <dir> --skill-policy <skill-policy.yaml> [--insight-policy <insight-policy.yaml> --reviewer-response <reviewer-response.json>] [--mode fake|real] [--confirm-worker-dispatch]
