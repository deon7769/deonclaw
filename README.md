...
- MCP fake/test smoke, fake read-only tool-smoke, real read-only discovery, and policy-gated real read-only call-smoke with split fake/real policy examples and artifact leak scanning
